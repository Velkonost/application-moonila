...
import com.moonila.extensions.BuildTypeDebug
import com.moonila.extensions.BuildTypeRelease
import com.moonila.extensions.getKeystoreProperty
...
plugins {
    ...
    id("com.moonila.checks.dependency-updates")
}
